...
export default function Navbar() {
  return (
    <nav className="sticky top-0 lg:mx-60">
      <div className="navbar bg-base-100">
        ...
        <div className="flex-1 mx-4">
          <a className="btn btn-ghost text-xl">
            <img src="/images/png/WhiteLogo.png" alt="logo" className="w-auto h-full" />
          </a>
        </div>
        <div className="flex-none">
            <label className="swap swap-rotate shadow-inset h-12 w-12 rounded-full">
              <input type="checkbox" />
              <svg
